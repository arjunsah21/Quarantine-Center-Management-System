            ...
            for(int checker=0; checker<total_entries; checker++)
            {
                ...
                else
                {
                    ...
                    if(age>0&&age<=40)
                    {
                        ...
                        {
                            cout<<"Your room will be on ground floor,please choose a room between 101-300(both inclusive) : ";
                            cin>>room;
                            floor=1;
                            while(covid_map[room]!=NULL || (room<=101||room>300))
                            {
                    ...
                    else if(age>40&&age<=60)
                    {
                        ...
                        {
                            cout<<"Your room will be on first floor,please choose a room between 1-100(both inclusive) : ";
                            cin>>room;
                            floor=0;
                            while(covid_map[room]!=NULL || (room<=1||room>100))
                            {
                                if(room<=1||room>100)
                                {
